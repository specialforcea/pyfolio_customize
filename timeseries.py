...
SIMPLE_STAT_FUNCS = [
    ...
    # ep.annualized_1year_return,
    # ep.annualized_5year_return,
    # ep.annualized_10year_return,
    ep.annual_volatility,
    # ep.annuallized_1year_volatility,
    # ep.annuallized_5year_volatility,
    # ep.annuallized_10year_volatility,
    ep.sharpe_ratio,
    # ep._1year_sharpe_ratio,
    # ep._5year_sharpe_ratio,
    # ep._10year_sharpe_ratio,
    ep.calmar_ratio,
...
STAT_FUNC_NAMES = {
    ...
    'annualized_1year_return': 'Annualized_1year_return',
    'annualized_5year_return': 'Annualized_5year_return',
    'annualized_10year_return': 'Annualized_10year_return',
    'annual_volatility': 'Annual volatility',
    'annuallized_1year_volatility': 'Annuallized_1year_volatility',
    'annuallized_5year_volatility': 'Annuallized_5year_volatility',
    'annuallized_10year_volatility': 'Annuallized_10year_volatility',
    'sharpe_ratio': 'Sharpe ratio',
    '_1year_sharpe_ratio': '1 year sharpe ratio',
    '_5year_sharpe_ratio': '5 year sharpe ratio',
    '_10year_sharpe_ratio': '10 year sharpe ratio',
